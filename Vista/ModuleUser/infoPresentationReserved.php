...
$cod_reserve = ManejoReservation::consultReservationDocumentStatus($documento,$_SESSION['codUser']);
//$documento =  1;
...
if ($t_documento->getCod_t_documento() == 3) {
                            ...
                            <div class="product__info__main">
                                ...
                                <div class="box-tocart d-flex">
                                    <div class="addtocart__actions">
                                        <button class="tocart" type="submit" onclick="window.location='ModuleUser/actionDevolution.php?cod_res=<?php echo $cod_reserve->getCod_reserva() ?>&status=devolution'" title="Devolution">Make Devolution</button>
                                    </div>
                                </div>
                            </div>
                        </div>
