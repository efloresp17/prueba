...
$reservedActivated = ManejoReservation::getListStatusAct($codigoUsuarioActual->getCod_usuario());
?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="bradcaump__inner text-center">
                    <h2 class="bradcaump-title">My Reserved - Profile</h2>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-12 order-1 order-lg-2">
                ...
                <!--AQUI SE MUESTRAN LOS LIBROS QUE YO HE RESERVADO-->
                <div class="tab__container">
                    <div class="shop-grid tab-pane fade show active" id="nav-grid" role="tabpanel">
                        <div class="row">
                            <!-- Start Single Product -->
                            <?php
                            foreach ($reservedActivated as $d) {
                                $docs = ManejoDocument::consult($d->getCod_documento());
                                $tipo = ManejoDocument_Type::consult($docs->getCod_t_documento());
                                    ...
                                    echo '                                    
                                        ...
                                        <div class="product">
                                            <div class="product__thumb">
                                                <a class="first__img" href="?menu=infoBookReserved' . $d->getCod_documento() . '"><img src="boighor/images/product/1.jpg" alt="product image"></a>
                                                <a class="second__img animation1" href="?menu=infoBookReserved:' . $d->getCod_documento() . '"><img src="boighor/images/product/2.jpg" alt="product image"></a>
                                                <div class="new__box">
                                            ...
                                            <div class="product__content">
                                                <h4><a href="single-product.html">' . $docs->getTitulo() . '</a></h4>
                                            </div>
                                        </div>
                                    </div>';
                                }
                                if ($tipo->getCod_t_documento() == 2) {
                                    ...
                                    echo '                                    
                                        ...
                                        <div class="product">
                                            <div class="product__thumb">
                                                <a class="first__img" href="?menu=infoArticleReserved' . $d->getCod_documento() . '"><img src="boighor/images/product/1.jpg" alt="product image"></a>
                                                <a class="second__img animation1" href="?menu=infoArticleReserved:' . $d->getCod_documento() . '"><img src="boighor/images/product/2.jpg" alt="product image"></a>
                                                <div class="new__box">
                                                    <span class="new-label">' . $tipo->getNom_t_documento() . '</span>
                                                </div>
                                                <ul class="prize position__right__bottom d-flex">
                                ...
                                if ($tipo->getCod_t_documento() == 3) {
                                    ...
                                    echo '                                    
                                        ...
                                        <div class="product">
                                            <div class="product__thumb">
                                                <a class="first__img" href="?menu=infoPresentationReserved' . $d->getCod_documento() . '"><img src="boighor/images/product/1.jpg" alt="product image"></a>
                                                <a class="second__img animation1" href="?menu=infoPresentationReserved:' . $d->getCod_documento() . '"><img src="boighor/images/product/2.jpg" alt="product image"></a>
                                                <div class="new__box">
                                                    <span class="new-label">' . $tipo->getNom_t_documento() . '</span>
                                                </div>
                                                <ul class="prize position__right__bottom d-flex">
