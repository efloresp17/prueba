<?php
    ...
    $users = ManejoUser::getUserListByType(6);//6 code for the editorials
...
<div class="card-header" style="background-color: #C0392B;">
        ...
        <h3 style="color: #fff">Editorials Table</h3>
        ...
        <div class="card-header-right">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown-7" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                        <a class="dropdown-item waves-light waves-effect" href="exportPDF.php?tipoUsuario=5">PDF</a>
                        <a class="dropdown-item waves-light waves-effect" href="exportExcel.php?tipoUsuario=5">XLS</a>

            </div>
            
            <a type="button" href="?menu=registerUser&userType=6" class="btn hor-grd btn-grd-inverse btn-round ">Add Editorial</a>
                ...
                <tr>    
                        ...
                        <td>
                            ...
                            <?php }else{
                                ...
                                <?php }?>
                                <a type="button" href="?menu=editUser&codeUser=<?php echo $users[$i]->getCod_usuario();?>&userType=6" style="color: #fff;" class="btn btn-warning btn-round"><i class="icofont icofont-ui-edit"></i>Edit</a>
