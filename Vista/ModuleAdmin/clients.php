<?php
    ...
    $users = ManejoUser::getUserListByType(1);//1 code for the clients
...
<div class="card-header" style="background-color: #05cfb3;">
        ...
        <div class="card-header-right">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown-7" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                        <a class="dropdown-item waves-light waves-effect" href="exportPDF.php?tipoUsuario=3">PDF</a>
                        <a class="dropdown-item waves-light waves-effect" href="exportExcel.php?tipoUsuario=3">XLS</a>

            </div>
            <a type="button" href="?menu=registerUser&userType=1" class="btn hor-grd btn-grd-inverse btn-round ">Add Clients</a>
        </div>
    </div>
                ...
                <tr>    
                        ...
                        <td>
                            ...
                            <?php }else{
                                ...
                                <?php }?>
                                <a type="button" href="?menu=editUser&codeUser=<?php echo $users[$i]->getCod_usuario();?>&userType=1" style="color: #fff;" class="btn btn-warning btn-round"><i class="icofont icofont-ui-edit"></i>Edit</a>
