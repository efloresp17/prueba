<?php
    ...
    $users = ManejoUser::getUserListByType(4); //4 code for the readers
...
<div class="card-header" style="background-color: #C0392B;">
        <h3 style="color: #fff">Readers Table</h3>
        ...
        <div class="card-header-right">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown-7" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                        <a class="dropdown-item waves-light waves-effect" href="exportPDF.php?tipoUsuario=2">PDF</a>
                        <a class="dropdown-item waves-light waves-effect" href="exportExcel.php?tipoUsuario=2">XLS</a>

            </div>
            
            <a type="button" href="?menu=registerUser&userType=4" class="btn hor-grd btn-grd-inverse btn-round ">Add Reader</a>
        </div>
                ...
                <?php for ($i=0; $i <count($users) ; $i++) { 
                    ...
                    <tr> 
                        ...
                        <td>
                            ...
                            <?php }?>
                            <a type="button" href="?menu=editUser&codeUser=<?php echo $users[$i]->getCod_usuario();?>&userType=4" style="color: #fff;" class="btn btn-warning btn-round"><i class="icofont icofont-ui-edit"></i>Edit</a>
